...
class ViewController_VilaIdetFria: UIViewController {
    //Change start time sound
    @IBOutlet weak var action: UISwitch!
    
    @IBAction func switchAction(_ sender: UISwitch) {
    }
    
     //END Change start time sound
    ...
    override func viewDidLoad() {
        ...
        let musicFileVilaMotTrad = Bundle.main.path(forResource: "VilaIdetFria", ofType: ".mp3")
